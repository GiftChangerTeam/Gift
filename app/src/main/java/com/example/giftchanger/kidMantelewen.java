...
public class kidMantelewen extends AppCompatActivity {
    ...
    private void setInitialData() {
        presents.add(new Present("Тут мальчики","7-11 лет","*картиночка*")); // тут вводим каждый предмет по отдельности
