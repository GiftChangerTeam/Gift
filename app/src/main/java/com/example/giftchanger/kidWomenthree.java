...
public class kidWomenthree extends AppCompatActivity {// Это активность где будет список подарков выводиться кароч
    ...
    private void setInitialData() {
        presents.add(new Present("Кукла","3000","*картиночка*")); // тут вводим каждый предмет по отдельности
