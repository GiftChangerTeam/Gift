...
public class kidWomensix extends AppCompatActivity {// Это активность где будет список подарков выводиться кароч
    ...
    private void setInitialData() {
        presents.add(new Present("Кукла","700",R.drawable.img)); // тут вводим каждый предмет по отдельности
