...
public class kidManeighteen extends AppCompatActivity {
    ...
    private void setInitialData() {
        presents.add(new Present("Тут мальчики","18-34 лет","*картиночка*")); // тут вводим каждый предмет по отдельности
