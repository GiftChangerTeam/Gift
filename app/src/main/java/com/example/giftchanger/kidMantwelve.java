...
public class kidMantwelve extends AppCompatActivity {
    ...
    private void setInitialData() {
        presents.add(new Present("Тут мальчики","12-17 лет","*картиночка*")); // тут вводим каждый предмет по отдельности
